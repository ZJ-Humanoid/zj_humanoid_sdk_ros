...
### 1. `/zj_humanoid/hand/finger_pressures/left/zero`
...
### 2. `/zj_humanoid/hand/gesture_switch/dual`
...
### 3. `/zj_humanoid/hand/gesture_switch/left`
...
### 4. `/zj_humanoid/hand/gesture_switch/right`
...
### 5. `/zj_humanoid/hand/joint_switch/dual`
...
### 6. `/zj_humanoid/hand/joint_switch/left`
...
### 7. `/zj_humanoid/hand/joint_switch/right`
...
### 8. `/zj_humanoid/hand/task_switch/left`
...
### 9. `/zj_humanoid/hand/task_switch/right`
...
### 11. `/zj_humanoid/hand/wrist_force_sensor/left/zero`
...
### 1. `/zj_humanoid/hand/finger_pressures/left`
...
### 2. `/zj_humanoid/hand/finger_pressures/right`
...
### 3. `/zj_humanoid/hand/joint_states`
...
### 4. `/zj_humanoid/hand/wrist_force_sensor/left`
...
### 5. `/zj_humanoid/hand/wrist_force_sensor/right`
