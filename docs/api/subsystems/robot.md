...
### 1. `/zj_humanoid/robot/basic_info`
...
### 2. `/zj_humanoid/robot/face_show/media_play`
...
### 3. `/zj_humanoid/robot/face_show/text_show`
...
### 4. `/zj_humanoid/robot/joint_motor/set_zero`
...
### 5. `/zj_humanoid/robot/orin_states/connect_wifi`
...
### 6. `/zj_humanoid/robot/orin_states/wifi_list`
...
### 7. `/zj_humanoid/robot/pico_states/connect_wifi`
...
### 8. `/zj_humanoid/robot/pico_states/wifi_list`
...
### 9. `/zj_humanoid/robot/set_robot_state/OFF`
...
### 10. `/zj_humanoid/robot/set_robot_state/restart`
...
### 11. `/zj_humanoid/robot/set_robot_state/run`
...
### 12. `/zj_humanoid/robot/set_robot_state/stop`
...
### 1. `/zj_humanoid/robot/battery_info`
...
### 2. `/zj_humanoid/robot/joint_motor/errors`
...
### 3. `/zj_humanoid/robot/joint_motor/temperatures`
...
### 5. `/zj_humanoid/robot/orin_states/errors`
...
### 6. `/zj_humanoid/robot/orin_states/resource`
...
### 7. `/zj_humanoid/robot/pico_states/errors`
...
### 8. `/zj_humanoid/robot/pico_states/resource`
...
### 9. `/zj_humanoid/robot/robot_state`
...
### 10. `/zj_humanoid/robot/work_status_form_start`
