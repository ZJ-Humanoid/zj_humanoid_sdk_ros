...
### 1. `/zj_humanoid/upperlimb/FK/left_arm`
...
### 2. `/zj_humanoid/upperlimb/FK/right_arm`
...
### 3. `/zj_humanoid/upperlimb/IK/left_arm`
...
### 4. `/zj_humanoid/upperlimb/IK/right_arm`
...
### 5. `/zj_humanoid/upperlimb/go_down/dual_arm`
...
### 6. `/zj_humanoid/upperlimb/go_down/left_arm`
...
### 7. `/zj_humanoid/upperlimb/go_down/right_arm`
...
### 8. `/zj_humanoid/upperlimb/go_home/dual_arm`
...
### 9. `/zj_humanoid/upperlimb/go_home/left_arm`
...
### 10. `/zj_humanoid/upperlimb/go_home/lifting`
...
### 11. `/zj_humanoid/upperlimb/go_home/neck`
...
### 12. `/zj_humanoid/upperlimb/go_home/right_arm`
...
### 13. `/zj_humanoid/upperlimb/go_home/waist`
...
### 14. `/zj_humanoid/upperlimb/go_home/whole_body`
...
### 15. `/zj_humanoid/upperlimb/movej/dual_arm`
...
### 16. `/zj_humanoid/upperlimb/movej/left_arm`
...
### 17. `/zj_humanoid/upperlimb/movej/lift`
...
### 18. `/zj_humanoid/upperlimb/movej/neck`
...
### 19. `/zj_humanoid/upperlimb/movej/right_arm`
...
### 20. `/zj_humanoid/upperlimb/movej/waist`
...
### 21. `/zj_humanoid/upperlimb/movej/whole_body`
...
### 22. `/zj_humanoid/upperlimb/movej_by_path/dual_arm`
...
### 23. `/zj_humanoid/upperlimb/movej_by_path/left_arm`
...
### 24. `/zj_humanoid/upperlimb/movej_by_path/right_arm`
...
### 25. `/zj_humanoid/upperlimb/movej_by_pose/dual_arm`
...
### 26. `/zj_humanoid/upperlimb/movej_by_pose/left_arm`
...
### 27. `/zj_humanoid/upperlimb/movej_by_pose/right_arm`
...
### 28. `/zj_humanoid/upperlimb/movel/dual_arm`
...
### 29. `/zj_humanoid/upperlimb/movel/left_arm`
...
### 30. `/zj_humanoid/upperlimb/movel/right_arm`
...
### 31. `/zj_humanoid/upperlimb/servoj/clear_params`
...
### 32. `/zj_humanoid/upperlimb/servoj/set_params`
...
### 33. `/zj_humanoid/upperlimb/servol/clear_params`
...
### 34. `/zj_humanoid/upperlimb/servol/set_params`
...
### 35. `/zj_humanoid/upperlimb/speedl/enable_speedl`
...
### 36. `/zj_humanoid/upperlimb/stop_robot`
...
### 37. `/zj_humanoid/upperlimb/teach_mode/enter`
...
### 38. `/zj_humanoid/upperlimb/teach_mode/exit`
...
### 39. `/zj_humanoid/upperlimb/versions`
...
### 1. `/zj_humanoid/upperlimb/cmd_states`
...
### 2. `/zj_humanoid/upperlimb/joint_states`
...
### 3. `/zj_humanoid/upperlimb/servoj/left_arm`
...
### 4. `/zj_humanoid/upperlimb/servoj/neck`
...
### 5. `/zj_humanoid/upperlimb/servoj/right_arm`
...
### 6. `/zj_humanoid/upperlimb/servoj/waist`
...
### 7. `/zj_humanoid/upperlimb/servoj/whole_body`
...
### 8. `/zj_humanoid/upperlimb/servol/dual_arm`
...
### 9. `/zj_humanoid/upperlimb/servol/left_arm`
...
### 10. `/zj_humanoid/upperlimb/servol/right_arm`
...
### 11. `/zj_humanoid/upperlimb/speedj/enable_speedj`
...
### 12. `/zj_humanoid/upperlimb/speedj/left_arm`
...
### 13. `/zj_humanoid/upperlimb/speedj/lift`
...
### 14. `/zj_humanoid/upperlimb/speedj/neck`
...
### 15. `/zj_humanoid/upperlimb/speedj/right_arm`
...
### 16. `/zj_humanoid/upperlimb/speedj/waist`
...
### 17. `/zj_humanoid/upperlimb/speedj/whole_body`
...
### 18. `/zj_humanoid/upperlimb/speedl/dual_arm`
...
### 19. `/zj_humanoid/upperlimb/speedl/left_arm`
...
### 20. `/zj_humanoid/upperlimb/speedl/right_arm`
...
### 21. `/zj_humanoid/upperlimb/tcp_pose/left_arm`
...
### 22. `/zj_humanoid/upperlimb/tcp_pose/right_arm`
...
### 23. `/zj_humanoid/upperlimb/tcp_speed`
