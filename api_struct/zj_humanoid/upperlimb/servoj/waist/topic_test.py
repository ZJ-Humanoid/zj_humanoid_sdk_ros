...
Topic: /zj_humanoid/upperlimb/servoj/waist
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_upperlimb_servoj_waist', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/upperlimb/servoj/waist', Joints, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/upperlimb/servoj/waist at 10Hz...")
