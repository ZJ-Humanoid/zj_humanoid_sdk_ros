...
Topic: /zj_humanoid/upperlimb/speedl/dual_arm
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_upperlimb_speedl_dual_arm', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/upperlimb/speedl/dual_arm', SpeedL, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/upperlimb/speedl/dual_arm at 10Hz...")
