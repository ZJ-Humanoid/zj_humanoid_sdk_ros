...
Topic: /zj_humanoid/upperlimb/speedl/left_arm
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_upperlimb_speedl_left_arm', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/upperlimb/speedl/left_arm', SpeedL, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/upperlimb/speedl/left_arm at 10Hz...")
