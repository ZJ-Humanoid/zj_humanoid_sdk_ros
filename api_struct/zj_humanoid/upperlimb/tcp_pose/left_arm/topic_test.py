...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_upperlimb_tcp_pose_left_arm', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/upperlimb/tcp_pose/left_arm', Pose, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/upperlimb/tcp_pose/left_arm at 10Hz...")
