...
Topic: /zj_humanoid/upperlimb/tcp_speed
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_upperlimb_tcp_speed', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/upperlimb/tcp_speed', TcpSpeed, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/upperlimb/tcp_speed at 10Hz...")
