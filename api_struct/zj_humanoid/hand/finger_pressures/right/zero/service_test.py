...
Service: /zj_humanoid/hand/finger_pressures/right/zero
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('service_test_zj_humanoid_hand_finger_pressures_right_zero', anonymous=True)
    
    # Load request data from YAML
    data = load_yaml_data(yaml_file)
    
    # Wait for service
    service_name = '/zj_humanoid/hand/finger_pressures/right/zero'
