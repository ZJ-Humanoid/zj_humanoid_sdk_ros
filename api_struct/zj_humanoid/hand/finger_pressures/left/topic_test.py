...
Topic: /zj_humanoid/hand/finger_pressures/left
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_hand_finger_pressures_left', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/hand/finger_pressures/left', PressureSensor, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/hand/finger_pressures/left at 10Hz...")
