...
Topic: /zj_humanoid/lowerlimb/set_lie
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_lowerlimb_set_lie', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/lowerlimb/set_lie', Float32, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/lowerlimb/set_lie at 10Hz...")
