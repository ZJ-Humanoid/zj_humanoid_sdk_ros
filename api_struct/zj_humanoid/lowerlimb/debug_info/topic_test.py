...
Topic: /zj_humanoid/lowerlimb/debug_info
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_lowerlimb_debug_info', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/lowerlimb/debug_info', String, queue_size=10)
    
    # Create message
    msg = dict_to_msg(data, String)
    
    # Publish at 10Hz
    rate = rospy.Rate(10)
    
    rospy.loginfo(f"Publishing to /zj_humanoid/lowerlimb/debug_info at 10Hz...")
