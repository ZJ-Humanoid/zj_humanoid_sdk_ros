...
Topic: /zj_humanoid/lowerlimb/cmd_vel/joy
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_lowerlimb_cmd_vel_joy', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/lowerlimb/cmd_vel/joy', Twist, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/lowerlimb/cmd_vel/joy at 10Hz...")
