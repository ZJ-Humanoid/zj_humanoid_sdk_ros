...
Topic: /zj_humanoid/sensor/realsense_up/color/camera_info
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_sensor_realsense_up_color_camera_info', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/sensor/realsense_up/color/camera_info', CameraInfo, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/sensor/realsense_up/color/camera_info at 10Hz...")
