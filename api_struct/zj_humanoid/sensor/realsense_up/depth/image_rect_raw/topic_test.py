...
Topic: /zj_humanoid/sensor/realsense_up/depth/image_raw
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_sensor_realsense_up_depth_image_raw', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/sensor/realsense_up/depth/image_raw', Image, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/sensor/realsense_up/depth/image_raw at 10Hz...")
