...
Topic: /zj_humanoid/sensor/CAM_C/image_raw
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_sensor_CAM_C_image_raw', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/sensor/CAM_C/image_raw', Image, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/sensor/CAM_C/image_raw at 10Hz...")
