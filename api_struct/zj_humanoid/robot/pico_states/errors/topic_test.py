...
Topic: /zj_humanoid/robot/pico_states/errors
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_robot_pico_states_errors', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/robot/pico_states/errors', Errors, queue_size=10)
    ...
    rospy.loginfo(f"Publishing to /zj_humanoid/robot/pico_states/errors at 10Hz...")
