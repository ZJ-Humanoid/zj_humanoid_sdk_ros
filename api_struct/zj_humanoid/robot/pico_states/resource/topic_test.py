...
Topic: /zj_humanoid/robot/pico_states/resource
...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_robot_pico_states_resource', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/robot/pico_states/resource', Resource, queue_size=10)
    
    # Create message
    msg = dict_to_msg(data, Resource)
    
    # Publish at 10Hz
    rate = rospy.Rate(10)
    
    rospy.loginfo(f"Publishing to /zj_humanoid/robot/pico_states/resource at 10Hz...")
