...
def main():
    ...
    # Initialize ROS node
    rospy.init_node('topic_test_zj_humanoid_robot_work_status_form_start', anonymous=True)
    
    # Load data from YAML
    data = load_yaml_data(yaml_file)
    
    # Create publisher
    pub = rospy.Publisher('/zj_humanoid/robot/work_status_form_start', WorkStatus, queue_size=10)
    
    # Create message
    msg = dict_to_msg(data, WorkStatus)
